IF NOT EXISTS (
    ...
    FROM
        sys.databases
    WHERE
        name = 'WAVERLEY_CHALLENGE_GMV'
) BEGIN CREATE DATABASE WAVERLEY_CHALLENGE_GMV;

END USE WAVERLEY_CHALLENGE_GMV
GO
...
GO
    CREATE TABLE [dbo].[BillingAddress](
        ...
        PRIMARY KEY CLUSTERED ([BillingAddressID] ASC) WITH (
            PAD_INDEX = OFF,
...
GO
    CREATE TABLE [dbo].[Customer](
        ...
        PRIMARY KEY CLUSTERED ([CustomerID] ASC) WITH (
            PAD_INDEX = OFF,
            STATISTICS_NORECOMPUTE = OFF,
            IGNORE_DUP_KEY = OFF,
            ALLOW_ROW_LOCKS = ON,
...
GO
    CREATE TABLE [dbo].[ShippingAddress](
        ...
        [Address] [nvarchar](200) NOT NULL,
        PRIMARY KEY CLUSTERED ([ShippingAddressID] ASC) WITH (
            PAD_INDEX = OFF,
            STATISTICS_NORECOMPUTE = OFF,
            IGNORE_DUP_KEY = OFF,
            ALLOW_ROW_LOCKS = ON,
...
ALTER TABLE
    [dbo].[OrderDetail]
ADD
    DEFAULT (newid()) FOR [OrderDetailID]
GO
ALTER TABLE
    [dbo].[Product]
ADD
    DEFAULT (newid()) FOR [ProductID]
GO
ALTER TABLE
    [dbo].[Category] WITH CHECK
ADD
    FOREIGN KEY([ParentCategoryID]) REFERENCES [dbo].[Category] ([CategoryID])
GO
ALTER TABLE
    [dbo].[Order] WITH CHECK
ADD
    FOREIGN KEY([BillingAddressID]) REFERENCES [dbo].[BillingAddress] ([BillingAddressID])
GO
ALTER TABLE
    [dbo].[Order] WITH CHECK
ADD
...
ALTER TABLE
    [dbo].[Order] WITH CHECK
ADD
    FOREIGN KEY([ShippingAddressID]) REFERENCES [dbo].[ShippingAddress] ([ShippingAddressID])
GO
ALTER TABLE
    [dbo].[OrderDetail] WITH CHECK
ADD
...
GO
ALTER TABLE
    [dbo].[Order] CHECK CONSTRAINT [CHK_OrderStatus]
GO
ALTER TABLE
    [dbo].[Product] WITH CHECK
ADD
    CONSTRAINT [CHK_ProductWeight] CHECK (([Weight] >(0)))
GO
ALTER TABLE
    [dbo].[Product] CHECK CONSTRAINT [CHK_ProductWeight]
GO
ALTER TABLE
    [dbo].[Product] WITH CHECK
ADD
    CONSTRAINT [CHK_ProductWeightUnit] CHECK (([WeightUnit] = 'kg'))
GO
ALTER TABLE
    [dbo].[Product] CHECK CONSTRAINT [CHK_ProductWeightUnit]
GO